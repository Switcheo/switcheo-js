declare module 'web3' {
  ...
  type MixedData = string | number | object | ReadonlyArray<any> | BigNumber.BigNumber

  class Web3 { // tslint:disable-line
  ...
  namespace providers {
      class HttpProvider implements Provider { // tslint:disable-line
  ...
  namespace Web3 {
      ...
      interface Contract<A extends ContractInstance> {
        at(address: string): A
        getData(...args: any[]): string // tslint:disable-line
        'new'(...args: any[]): A // tslint:disable-line
      }
      ...
      interface EthApi {
        ...
        getAccounts(cd: (err: Error, accounts: ReadonlyArray<string>) => void): void
        ...
        isSyncing(cb: (err: Error, isSyncing: boolean, syncingState: Web3.SyncingState)
          => void): Web3.IsSyncing
        ...
        getTransaction(transactionHash: string, callback:
          (err: Error, transaction: Transaction) => void): void
        ...
        contract(abi: ReadonlyArray<AbiDefinition>): Web3.Contract<any>
        ...
        getStorageAt(address: string, position: number,
          callback: (err: Error, storage: string) => void): void
      ...
      interface PersonalApi {
        listAccounts: ReadonlyArray<string> | undefined
        ...
        sign(hexMessage: string, account: string,
          callback: (error: Error, signature: string) => void): void
      }
